...
function getStatusLabel(
  ...
  if (saveState === 'saving') return 'Đang tự động lưu...'
  if (saveState === 'unsaved') return 'Thay đổi chưa lưu'
  if (saveState === 'error') return 'Lưu thất bại'
